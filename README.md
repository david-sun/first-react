## Important Note:
1. Have problem to call backend, and I add dumy data if the call failed
2. Use the jQuery event to trigger the view switch. I have no idea if the react.js has this mechanism.
